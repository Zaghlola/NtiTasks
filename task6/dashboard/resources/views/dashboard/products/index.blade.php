...
<div class="col-12">
  ...
  @if (session('success'))
  <div class="alert alert-success text-center font-weighted-bold py-3">
      {{ session('success') }}
  </div>
@endif
  ...
  <div class="col-12">
    ...
    <tbody>
      ...
      <tr>
        ...
        ])>{{$product->quantity ==0? 'OutOf Stock' :$product->quantity}}</td>
         <td >
        ...
        <td>
          <a href="{{route('dashboard.products.edit',['id'=>$product->id])}}" class="btn btn-outline-primary btn-sm rounded">Edit</a>
